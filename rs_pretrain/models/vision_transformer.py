...
#         "million_aid": "/nfs/dgx/raid/rs/rs/results/maid_ibot_base_fa2_ddp/checkpoint0195.pth",
#     },
# }
...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        ## print("qkv_copy.shape", qkv_copy.shape)
        ## x_copy = flash_attn_qkvpacked_func(qkv_copy).reshape(B, N, C)
        ...
        ## print("x", x[0][0][:3])
        ## print("x_copy", x_copy[0][0][:3])

        x = self.proj(x)
        #### x = checkpoint.checkpoint(self.custom(self.proj), x)
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=[224], patch_size=16, in_chans=3, num_classes=0, embed_dim=768, depth=12,
                 ...
                 init_values=0, use_mean_pooling=False, masked_im_modeling=False, return_feats=False):
        super().__init__()
    ...
    def forward(self, x, return_all_tokens=None, mask=None, ret_feats=False):
        # mim
        feats = []
