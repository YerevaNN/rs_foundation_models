...
from .base_encoder_pangea import Encoder
from .pos_embed_pangea import get_3d_sincos_pos_embed
...
new_settings = {
    "Prithvi_100M": {
        "HLS-2": "/nfs/ap/mnt/frtn/rs-base-models/prithvi_weights
/Prithvi_100M.pt",  
    },
}
...
for model_name, sources in new_settings.items():
    ...
    for source_name, source_url in sources.items():
        ...
        pretrained_settings[model_name]["encoder_weights"] = source_url
...
prithvi_encoders_pangea = {
    "prithvi": {
        "encoder": Prithvi_Encoder,
        "pretrained_settings": pretrained_settings['Prithvi_100M'],
        "params": {
            "depth": 12,
            "embed_dim": 768,
            "input_size": 224,
            ...
            "output_dim": (768, 768, 768, 768), 
            "input_bands": ("B02", "B03", "B04", "B8A", "B11", "B12"),
            'download_url': None, 
            'encoder_weights':  pretrained_settings['Prithvi_100M']['encoder_weights']
        }
    }
}