...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=[224], patch_size=16, in_chans=3, num_classes=0, embed_dim=768, depth=12,
                 ...
                 init_values=0, use_mean_pooling=False, masked_im_modeling=False, out_channels=None, out_idx=None):
        super().__init__()
...
vit_overlap_encoders = {
    "overlap_ibot-B": {
        "encoder": VisionTransformer,
        "pretrained_settings": pretrained_settings["overlap_ibot-B"],
        "params": {
            "embed_dim": 768,
            "patch_size": 16,
            "depth": 12, 
