...
from .pos_embed_pangea import get_1d_sincos_pos_embed_from_grid_torch
...
class DOFA_Encoder(Encoder):
    ...
    def __init__(
        ...
        self.wv_list = [
            self.wave_list[b] for b in self.input_bands
        ]
...
dofa_encoders = {
    "dofa": {
        ...
        "params": {
            ...
            "download_url": None, 
            "input_size": 224,
            "encoder_weights":  pretrained_settings['Dofa']['encoder_weights'],
            "input_bands": ("B02", "B03", "B04", "B05", "B06", "B07", "B08", "B11", "B12", "VH", "VV"),
