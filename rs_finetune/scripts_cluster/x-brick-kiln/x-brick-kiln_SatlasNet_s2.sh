...
#SBATCH --output=/mnt/weka/akhosrovyan/logs_geocrossbench/tmlr_x-brick-kiln_SatlasNet_s2_full_%j.log
#SBATCH --array=0-7
...
python \
  train_classifier.py \
  --experiment_name \
  brick-kiln/x-brick-kiln_SatlasNet_s2/seed${seed}_bs64_ep50_lr${lr} \
  --dataset_name \
  m_brick \
  --in_features \
  1024 \
  ...
  --checkpoint_path \
  /mnt/weka/akhosrovyan/ckpt_rs_finetune/classification/brick-kiln/x-brick-kiln_SatlasNet_s2 \
...
python \
  ...
  --checkpoint_path \
  /mnt/weka/akhosrovyan/ckpt_rs_finetune/classification/brick-kiln/x-brick-kiln_SatlasNet_s2/seed${seed}_bs64_ep50_lr${lr}/best-model.ckpt \
  --img_size \
  224 \
  --filename \
  /mnt/weka/akhosrovyan/logs_geocrossbench/cls/TMLR_x-brick-kiln_SatlasNet_s2_full_ \
  --bands \
